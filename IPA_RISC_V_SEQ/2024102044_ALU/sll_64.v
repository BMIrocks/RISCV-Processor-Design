module sll_64(
    ...
    generate
        for(i = 0; i < 64; i = i + 1) begin : stage0_gen
            wire shifted_bit;
            assign shifted_bit = (i == 0) ? 1'b0 : a[i-1];
    ...
    generate
        for(i = 0; i < 64; i = i + 1) begin : stage1_gen
            wire shifted_bit;
            assign shifted_bit = (i < 2) ? 1'b0 : stage0[i-2];
    ...
    generate
        for(i = 0; i < 64; i = i + 1) begin : stage2_gen
            wire shifted_bit;
            assign shifted_bit = (i < 4) ? 1'b0 : stage1[i-4];
    ...
    generate
        for(i = 0; i < 64; i = i + 1) begin : stage3_gen
            wire shifted_bit;
            assign shifted_bit = (i < 8) ? 1'b0 : stage2[i-8];
    ...
    generate
        for(i = 0; i < 64; i = i + 1) begin : stage4_gen
            wire shifted_bit;
            assign shifted_bit = (i < 16) ? 1'b0 : stage3[i-16];
    ...
    generate
        for(i = 0; i < 64; i = i + 1) begin : stage5_gen
            wire shifted_bit;
            assign shifted_bit = (i < 32) ? 1'b0 : stage4[i-32];
