...
module tb_xor_64;
    ...
    initial begin
        $dumpfile("tb_xor_64.vcd");
        $dumpvars(0, tb_xor_64);
        $display("xor_64 Testbench");

        a = 64'hAAAAAAAAAAAAAAAA; b = 64'hAAAAAAAAAAAAAAAA; #10;
        check(64'h0);
        ...
        a = 64'h123456789ABCDEF0; b = 64'hFEDCBA9876543210; #10;
        check(64'hECE8ECE0ECE8ECE0);
